...
class Generator:
    def __init__(self, params):
        ...
        self.mu = torch.DoubleTensor(params.batch_size_start, 1).uniform_(0., params.mu + torch.rand(1)[0]).requires_grad_(True)
        self.beta = torch.DoubleTensor(params.batch_size_start, 1).uniform_(0., params.mu + torch.rand(1)[0]).requires_grad_(True)
