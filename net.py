...
class SGD(Model):
    def __init__(self, params, eng, global_memory, model_params = None):
        ...
        print('sgd params: ',self.generator.parameters()[:-1])
        self.optimizer = torch.optim.Adagrad(self.generator.parameters()[:-1], lr = params.lr, weight_decay=0)
